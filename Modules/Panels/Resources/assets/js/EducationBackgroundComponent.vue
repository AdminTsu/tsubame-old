<template>
  <div>
    <div class="row" v-for='(e,k) in educations' :key='k'>
        <div class="col-md-3">
            <input type="text" v-model='educations[k].level' class="form-control" placeholder="SD/SMP/SMA/Universitas" value="">
        </div>
        <div class="col-md-2">
            <input type="text" v-model='educations[k].start' class="form-control" placeholder="Tahun Mulai" value="">
        </div>
        <div class="col-md-2">
            <input type="text" v-model='educations[k].end' placeholder="Tahun Selesai" class="form-control" value="">
        </div>
        <div class="col-md-3">
            <input type="text" v-model='educations[k].name' placeholder="Nama Sekolah/Institusi" class="form-control" value="">
        </div>
        <div class="col-md-2">
